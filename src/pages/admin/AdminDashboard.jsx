            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 bg-[#16181d] border border-[#262931] p-6 rounded-sm space-y-4">
                <div className="flex items-center justify-between border-b border-[#262931] pb-3">
                  ...
                  <Link to="/admin/orders" className="text-[10px] font-mono uppercase tracking-widest text-[#8c9472] hover:underline flex items-center gap-1">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#16181d] border border-[#262931] p-6 rounded-sm space-y-4">
                  <div className="flex items-center justify-between border-b border-[#262931] pb-3">
                    ...
                    <Link to="/admin/products" className="text-[10px] font-mono uppercase tracking-widest text-[#8c9472] hover:underline">
                      Manage
                    </Link>
                  </div>
